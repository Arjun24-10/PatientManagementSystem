...
export default function ResetPassword() {
  ...
  if (validatingToken) {
    return (
      <div className="min-h-screen relative overflow-hidden bg-gradient-to-br from-blue-50 via-purple-50 to-cyan-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 flex items-center justify-center">
        ...
        <div className="text-center relative z-10">
          ...
          <p className="text-gray-600 dark:text-slate-400 font-medium">Validating reset link...</p>
        </div>
      </div>
    );
  }
            ...
            <div className="hidden lg:block space-y-6 animate-fade-in">
              <div className="space-y-2">
                ...
                <h1 className="text-3xl font-bold leading-tight">
                  ...
                  <br />
                  <span className="text-gray-800 dark:text-slate-100">Secure Your Account</span>
                </h1>

                <p className="text-sm text-gray-600 dark:text-slate-400 max-w-md">
                  Choose a strong password to keep your account safe. We recommend using a unique password that you don't use for other sites.
                </p>
              ...
              <div className="space-y-4 relative z-20">
                ...
                {!tokenValid && (
                  <div className="text-center py-4">
                    ...
                    <p className="text-xs text-gray-600 dark:text-slate-400 mb-4 px-4">{error}</p>
                    <Link
                      to="/forgot-password"
                      className="inline-block w-full py-2.5 px-3 rounded-lg text-sm font-semibold text-white bg-gradient-to-r from-blue-600 to-purple-600 hover:shadow-lg transition-all text-center"
                    >
                ...
                {passwordReset && (
                  <div className="text-center py-4">
                    ...
                    <p className="text-gray-600 dark:text-slate-400 text-sm mb-6">Your password has been successfully updated.</p>
                    <button
                      onClick={() => navigate('/login')}
                      className="w-full py-2.5 px-3 rounded-lg text-sm font-semibold text-white bg-gradient-to-r from-blue-600 to-purple-600 hover:shadow-lg transition-all"
                    >
                ...
                {tokenValid && !passwordReset && (
                  <>
                    <div className="space-y-1">
                      ...
                      <p className="text-xs text-gray-600 dark:text-slate-400">Create a strong password for your account</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-3">
                      ...
                      <div className="space-y-1">
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            id="newPassword"
                            className={`w-full border-2 rounded-lg pl-8 pr-10 py-2 text-sm focus:outline-none focus:ring-2 transition-all bg-white dark:bg-slate-800 text-gray-900 dark:text-slate-100 placeholder-gray-500 dark:placeholder-slate-500 ${fieldErrors.newPassword
                      ...
                      <div className="space-y-1 p-2 bg-gray-50 dark:bg-slate-700/50 rounded-lg">
                        ...
                        <div className="space-y-1">
                          ...
                          <div className={`flex items-center text-xs ${passwordStrength.noWeakPatterns ? 'text-green-600 dark:text-green-400' : 'text-gray-500 dark:text-slate-400'}`}>
                      ...
                      <div className="space-y-1">
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            id="confirmPassword"
                            className={`w-full border-2 rounded-lg pl-8 pr-10 py-2 text-sm focus:outline-none focus:ring-2 transition-all bg-white dark:bg-slate-800 text-gray-900 dark:text-slate-100 placeholder-gray-500 dark:placeholder-slate-500 ${fieldErrors.confirmPassword
                                ? 'border-red-300 dark:border-red-500 focus:ring-red-500 focus:border-red-500'
                                : 'border-gray-300 dark:border-slate-600 focus:ring-blue-500 focus:border-blue-500'
                              }`}
