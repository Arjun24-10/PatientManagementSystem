      ...
      <div className="space-y-6">
         ...
         <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
               ...
               <p className="text-gray-500 dark:text-slate-400">View and download your laboratory test results</p>
            </div>
         ...
         <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <Card className="p-6 hover:shadow-md transition-shadow">
               <div className="flex items-center justify-between">
                  <div>
                     <p className="text-sm text-gray-500 dark:text-slate-400 mb-1">Total Tests</p>
                     <p className="text-3xl font-bold text-gray-800 dark:text-slate-100">{mockLabStats.totalTests}</p>
                  </div>
            ...
            <Card className="p-6 hover:shadow-md transition-shadow">
               <div className="flex items-center justify-between">
                  <div>
                     <p className="text-sm text-gray-500 dark:text-slate-400 mb-1">Pending Results</p>
                     <p className="text-3xl font-bold text-gray-800 dark:text-slate-100">{mockLabStats.pendingResults}</p>
                  </div>
            ...
            <Card className="p-6 hover:shadow-md transition-shadow">
               <div className="flex items-center justify-between">
                  <div>
                     <p className="text-sm text-gray-500 dark:text-slate-400 mb-1">Recent Abnormal</p>
                     <p className="text-3xl font-bold text-gray-800 dark:text-slate-100">{mockLabStats.recentAbnormal}</p>
                  </div>
                        ...
                        <div className="p-6">
                           <div className="flex flex-col md:flex-row justify-between md:items-start gap-4">
                              <div className="flex-1">
                                 <div className="flex items-start gap-4">
                                    ...
                                    <div className="flex-1">
                                       <h3 className="font-bold text-gray-800 dark:text-slate-100 text-lg mb-1">{result.testName}</h3>
                                       <div className="flex flex-wrap gap-4 text-sm text-gray-500 dark:text-slate-400 mb-2">
                                 ...
                                 {result.status === 'completed' && (
                                    <>
                                       ...
                                       <button
                                          ...
                                          className="px-4 py-2 bg-white dark:bg-slate-800 border border-gray-300 dark:border-slate-600 text-gray-700 dark:text-slate-200 rounded-lg hover:bg-gray-50 dark:hover:bg-slate-700/50 transition text-sm font-medium inline-flex items-center whitespace-nowrap"
                                       >
                           ...
                           {isExpanded && result.results && (
                              <div className="mt-6 pt-6 border-t border-gray-200 dark:border-slate-700">
                                 <h4 className="font-semibold text-gray-700 dark:text-slate-200 mb-4">Test Results</h4>
               ...
               <Card className="max-w-4xl w-full max-h-[90vh] overflow-y-auto">
                  <div className="p-6">
                     ...
                     <div className="flex justify-between items-start mb-6">
                        <div>
                           <h3 className="text-xl font-bold text-gray-800 dark:text-slate-100 mb-1">Trend Analysis</h3>
                           <p className="text-gray-600 dark:text-slate-300">{selectedTrendData.testName}</p>
                        </div>
                        <button
                     ...
                     {/* Chart Visualization */}
                     <div className="mb-6">
                        <h4 className="font-semibold text-gray-700 dark:text-slate-200 mb-4">Value Trend Over Time</h4>
                     ...
                     {/* Data Table */}
                     <div>
                        <h4 className="font-semibold text-gray-700 dark:text-slate-200 mb-4">Historical Values</h4>
                        <div className="overflow-x-auto">
                           <table className="w-full">
                              <thead>
                                 <tr className="bg-gray-50 dark:bg-slate-800/50">
                                    <th className="px-4 py-3 text-left text-xs font-semibold text-gray-600 dark:text-slate-300 uppercase">Date</th>
                                    <th className="px-4 py-3 text-left text-xs font-semibold text-gray-600 dark:text-slate-300 uppercase">Value</th>
                                    <th className="px-4 py-3 text-left text-xs font-semibold text-gray-600 dark:text-slate-300 uppercase">Status</th>
                                    <th className="px-4 py-3 text-left text-xs font-semibold text-gray-600 dark:text-slate-300 uppercase">Trend</th>
                                 </tr>
                              </thead>
                              <tbody className="divide-y divide-gray-200 dark:divide-slate-700">
                                 {selectedTrendData.data.map((point, idx) => {
                                    ...
                                    return (
                                       <tr key={idx} className={!point.normal ? 'bg-red-50/30 dark:bg-red-900/10' : ''}>
                                          ...
                                          <td className={`px-4 py-3 text-sm font-bold ${!point.normal ? 'text-red-600' : 'text-gray-800 dark:text-slate-100'}`}>
                                             {point.value}
                                          </td>
                                          <td className="px-4 py-3 text-sm">
                                             {point.normal ? (
