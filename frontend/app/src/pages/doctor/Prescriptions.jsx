    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    <h2 className="text-2xl font-bold text-gray-800 dark:text-slate-100">Prescriptions</h2>
                    <p className="text-gray-500 dark:text-slate-400">Manage patient medications and refills.</p>
                </div>
            ...
            <div className="grid gap-4">
                {filteredPrescriptions.map(rx => (
                    <Card key={rx.id} className="p-4 flex flex-col md:flex-row justify-between items-center hover:shadow-md transition-shadow dark:bg-slate-800">
                        <div className="flex items-center gap-4 w-full md:w-auto">
                            <div className="p-3 bg-purple-50 dark:bg-purple-900/20 text-purple-600 dark:text-purple-400 rounded-lg">
                                <Pill size={24} />
                            </div>
                            <div>
                                <h3 className="font-bold text-gray-800 dark:text-slate-100">{rx.name}</h3>
                                <div className="text-sm text-gray-500 dark:text-slate-400 flex flex-wrap gap-2">
                                    <span>{rx.dosage}</span>
                                    <span>•</span>
                        ...
                        <div className="flex items-center gap-6 mt-4 md:mt-0 w-full md:w-auto justify-between md:justify-end">
                            <div className="text-right mr-4">
                                <div className="text-sm text-gray-500 dark:text-slate-400">Prescribed By</div>
                                <div className="font-medium text-gray-800 dark:text-slate-100">{rx.prescribedBy}</div>
                            </div>
