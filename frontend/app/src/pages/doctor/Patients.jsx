    ...
    return (
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                <h2 className="text-2xl font-bold text-gray-800 dark:text-slate-100">My Patients</h2>
            ...
            <Card className="overflow-hidden dark:bg-slate-800">
                <div className="px-6 py-4 border-b dark:border-slate-700 flex justify-between items-center bg-gray-50 dark:bg-slate-700/50">
                    <h3 className="text-lg font-bold text-gray-800 dark:text-slate-100">Patient Directory</h3>
                    <span className="text-sm text-gray-500 dark:text-slate-400">{filteredPatients.length} records</span>
                </div>
                        ...
                        <table className="min-w-full divide-y divide-gray-200 dark:divide-slate-700">
                            <thead className="bg-gray-50 dark:bg-slate-700/50">
                                <tr>
                                    ...
                                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-slate-300 uppercase tracking-wider">Contact</th>
                                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-slate-300 uppercase tracking-wider">Condition</th>
                                    ...
                                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-slate-300 uppercase tracking-wider">Last Visit</th>
                                    ...
                                    <tr key={patient.id} className="hover:bg-gray-50 dark:hover:bg-slate-700/50 transition">
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <div className="flex items-center">
                                                ...
                                                <div className="ml-4">
                                                    <div className="text-sm font-medium text-gray-900 dark:text-slate-100">{patient.name}</div>
                                                    <div className="text-sm text-gray-500 dark:text-slate-400">ID: {patient.id}</div>
                                                    <div className="text-xs text-gray-400 dark:text-slate-500">{patient.age} yrs, {patient.gender}</div>
                                                </div>
                                            </div>
                                        </td>
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <div className="text-sm text-gray-900 dark:text-slate-100">{patient.email}</div>
                                            <div className="text-xs text-gray-500 dark:text-slate-400">{patient.phone}</div>
                                        </td>
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <span className="text-sm text-gray-900 dark:text-slate-100">{patient.condition}</span>
                                        </td>
                                        <td className="px-6 py-4 whitespace-nowrap">
