        ...
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                <div>
                    ...
                    <p className="text-gray-500">Access medical reports and practice analytics.</p>
                </div>
            ...
            <div className="grid gap-4">
                <h3 className="text-lg font-bold text-gray-800 mt-4">Recent Reports</h3>
                {mockReports.map(report => (
                    <Card key={report.id} className="p-4 flex flex-col md:flex-row justify-between items-center group hover:border-blue-300 transition-colors">
                        <div className="flex items-center gap-4 w-full md:w-auto">
                            ...
                            <div>
                                ...
                                <div className="text-sm text-gray-500 flex items-center gap-3">
                                    ...
                                    <span>•</span>
                                    <span className="uppercase bg-gray-100 px-2 py-0.5 rounded text-xs font-medium">{report.type}</span>
                                    <span>•</span>
