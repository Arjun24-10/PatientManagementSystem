...
const Profile = () => {
    ...
    return (
        <div className="space-y-6">
            <h2 className="text-2xl font-bold text-gray-800 dark:text-slate-100">Doctor Profile</h2>

            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                {/* Profile Card */}
                <Card className="p-6 lg:col-span-1 text-center dark:bg-slate-800">
                    <div className="w-32 h-32 rounded-full bg-blue-100 dark:bg-blue-900/30 mx-auto flex items-center justify-center text-blue-600 dark:text-blue-400 font-bold text-4xl mb-4">
                        DS
                    </div>
                    <h3 className="text-xl font-bold text-gray-900 dark:text-slate-100">Dr. Sarah Smith</h3>
                    <p className="text-blue-600 dark:text-blue-400 font-medium">Cardiologist (MBBS, MD)</p>
                    <p className="text-gray-500 dark:text-slate-400 text-sm mt-1">License #MD-12345-NY</p>
                    ...
                    <Card className="p-6 dark:bg-slate-800">
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-slate-700 rounded-lg">
                                <div>
                                    <p className="font-medium text-gray-800 dark:text-slate-100">Accepting New Patients</p>
                            ...
                            <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-slate-700 rounded-lg">
                                <div>
                                    <p className="font-medium text-gray-800 dark:text-slate-100">Show Phone Number</p>
                                    <p className="text-xs text-gray-500 dark:text-slate-400">Display contact number on public profile</p>
                                </div>
                                <div className="relative inline-block w-12 h-6 transition duration-200 ease-in-out bg-gray-300 dark:bg-slate-600 rounded-full cursor-pointer">
