        ...
        <Card className="h-full dark:bg-slate-800">
            ...
            <div className="divide-y divide-gray-100 dark:divide-slate-700">
                {notifications.map(note => (
                    <div key={note.id} className="p-4 hover:bg-gray-50 dark:hover:bg-slate-700/50 transition flex items-start">
                        ...
                        <div className="flex-1">
                            ...
                            <p className="text-xs text-gray-400 dark:text-slate-500 mt-1">{note.time}</p>
                        </div>
                        <button className="text-gray-300 dark:text-slate-600 hover:text-blue-500 dark:hover:text-blue-400">
                            <Check size={16} />
                        </button>
                    </div>
                ))}
                {notifications.length === 0 && (
                    <div className="p-8 text-center text-gray-400 dark:text-slate-500 text-sm">No new notifications</div>
                )}
            </div>
